...
var running3 = props.globals.getNode("/engines/engine[3]/running",1);
var starter3 = props.globals.getNode("/controls/engines/engine[3]/starter",1);
var enginerpm3 = props.globals.getNode("/engines/engine[3]/rpm");
...
var update_rpm = func 
{
  ...
  if (!(running3.getBoolValue()) and !(starter3.getBoolValue())) {
    enginerpm3.setValue(0);
  }
}
